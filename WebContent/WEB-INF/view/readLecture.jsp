...
<div id = "main">
	...
	<tr>
		...
		<a href = "lecture.do?subject=<%= request.getParameter("subject") %>&pageNo=${pageNo }">[목록]</a>
		<c:if test = "${authUser.id == articleData.article.writer.id }">
		<a href = "modify_Lecture.do?no=${articleData.article.number }&subject=<%= request.getParameter("subject") %>">[게시글 수정]</a>
		<a href = "delete_Lecture.do?no=${articleData.article.number }">[게시글 삭제]</a>
		</c:if>
		</td>
	</table>
</div>
